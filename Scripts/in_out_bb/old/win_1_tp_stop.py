...
def verificar_1(ativo = 'EURUSD'): 
   ...
   estr_1 = bb_ema(df,var_bb = 2.2,time_period = 30,pontos = 150,rate_stop = 1,rate_tp = 1)
...
def verificar_2(ativo = 'EURUSD'): 
   ...
   estr_2 = bb_ema(df,var_bb = 2.2,time_period = 20,pontos = 200,rate_stop = 1,rate_tp = 2)
...
while True: 
  ...
  if hour in [9,13,14,16,17]:
     if hour in [9,16]:
        if second == 59:
           verificar_1(ativo = 'WING23') 
     if hour in [9,13,14,17]:
        if second == 59:
